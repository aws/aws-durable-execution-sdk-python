...
| `aws-durable-execution-sdk-python-otel` | OpenTelemetry instrumentation for the execution SDK | [![PyPI - Version](https://img.shields.io/pypi/v/aws-durable-execution-sdk-python-otel.svg)](https://pypi.org/project/aws-durable-execution-sdk-python-otel) |
