...
def serialize(
    ...
    except (RetryableSerDesError, SerDesError):
        # Already a classified serdes failure: propagate unchanged so
        # metadata (data, stack_trace) survives into the checkpoint.
        raise
