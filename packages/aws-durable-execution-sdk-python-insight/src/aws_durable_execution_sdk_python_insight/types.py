...
def _validate_exporter_instances(exporters: Sequence[InsightExporter]) -> None:
    """Reject one exporter object appearing more than once by identity."""
...
class WorkflowInsightConfig:
    ...
    def __post_init__(self) -> None:
        ...
        _validate_exporter_instances(self.exporters)
