...
class UserFunctionEndInfo(OperationInfo):
    ...
    @classmethod
    def from_operation(
        cls, start_info, error: ErrorObject | None
    ) -> "UserFunctionEndInfo":
...
class PluginExecutor:
    ...
    def on_invocation_start(
        ...
        if execution_start_time is None:
            raise RuntimeError("Execution operation not found")
    ...
    def on_invocation_end(
        ...
        if self._invocation_status is None:
            raise RuntimeError("Invocation end called before invocation start")
    ...
    def on_user_function_end(self, start_info: UserFunctionStartInfo, error) -> None:
        ...
        self.execute_plugins(
            UserFunctionEndInfo.from_operation(start_info, error), sync=True
        )
